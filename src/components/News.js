...
const News = (props) => {
    ...
    useEffect(()=>{
        document.title = `Samachar - ${capitalized(props.category)}`;
        update();
    ...
    const fetchMoreData = async () => {
        ...
        return (
            ...
            <>
                <h2 style={{margin : "30px 0px", marginTop : "90px"}}><center>Samachar - Top {capitalized(props.category)} Headlines</center></h2>
                {loding && <Spinner/>}
                <InfiniteScroll
